...
****************************************************************************/
  ...
  #define GDFLIB_FILTER_IIR1_DEFAULT_F32 {{0,0,0},{0},{0}}     /*!< Default value for GDFLIB_FILTER_IIR1_T_F32. */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    Frac32 f32B0; /*!< B0 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    Frac32 f32B1; /*!< B1 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    Frac32 f32A1; /*!< A1 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    ...
    Frac32 f32FiltBufferX[1]; /*!< Input buffer of an IIR1 filter, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
    Frac32 f32FiltBufferY[1]; /*!< Internal accumulator buffer, fractional format normalized to fit into (-2\f$^{31}\f$, 2\f$^{31}\f$-1). */
...
****************************************************************************/
  ...
  extern Frac32 GDFLIB_FilterIIR1_F32(Frac32 f32In,GDFLIB_FILTER_IIR1_T_F32 * const pParam);
...
****************************************************************************/
  ...
  #define GDFLIB_FILTER_IIR1_DEFAULT_F16 {{0,0,0},{0},{0}}     /*!< Default value for GDFLIB_FILTER_IIR1_T_F16. */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    Frac16 f16B0; /*!< B0 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    Frac16 f16B1; /*!< B1 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    Frac16 f16A1; /*!< A1 coefficient of an IIR1 filter, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    ...
    Frac16 f16FiltBufferX[1]; /*!< Input buffer of an IIR1 filter, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
    Frac32 f32FiltBufferY[1]; /*!< Internal accumulator buffer, fractional format normalized to fit into (-2\f$^{15}\f$, 2\f$^{15}\f$-1). */
...
****************************************************************************/
  ...
  extern Frac16 GDFLIB_FilterIIR1_F16(Frac16 f16In,GDFLIB_FILTER_IIR1_T_F16 * const pParam);
