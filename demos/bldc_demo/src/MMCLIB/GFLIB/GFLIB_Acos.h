...
****************************************************************************/
  ...
  ****************************************************************************/
  extern Frac32 GFLIB_Acos_F32(Frac32 f32In,const GFLIB_ACOS_T_F32 *const pParam);
...
****************************************************************************/
  ...
  *//**********************************************************************/
  typedef struct{
    const Frac16  f16A[5];  /*!< Array of five 16-bit elements for storing coefficients of the piece-wise polynomial. */
  ...
  * Exported function prototypes
  ****************************************************************************/
  extern Frac16 GFLIB_Acos_F16(Frac16 f16In,const GFLIB_ACOS_T_F16 *const pParam);
