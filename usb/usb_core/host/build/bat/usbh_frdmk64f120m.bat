...
copy %USBROOTDIR%\usb_core\host\include\frdmk64f120m\usb_host_config.h %OUTPUTDIR%\usb_host_config.h /Y
...
copy %USBROOTDIR%\usb_core\host\sources\classes\msd\mfs\usbmfs.h %OUTPUTDIR%\usbmfs.h /Y
