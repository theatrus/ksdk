...
# Open nio_tfs_data.tmp for writing

open(OUTPUT, "> nio_tfs_data.tmp") or die "Can't create temporary file nio_tfs_data.tmp!\n";
print(OUTPUT "#include <nio_tfs.h>\n\n");
print(OUTPUT "extern const NIO_TFS_DIR_ENTRY nio_tfs_data[];\n\n");
...
# Finish nio_tfs_data.tmp file

print(OUTPUT "const NIO_TFS_DIR_ENTRY nio_tfs_data[] = {\n");
foreach $file (@INPUT_FILES)
{
  $fvar = "nio_tfs_" . $file;
  $fvar =~ s#[/\.]#_#g;
