 ...
 */
static HTTPSRV_AUTH_USER_STRUCT users[] = {
    {"developer", "freescale"},
 ...
 */
static HTTPSRV_AUTH_REALM_STRUCT auth_realms[] = {
    { "Please use uid:developer pass:freescale to login", "auth.html", HTTPSRV_AUTH_BASIC, (HTTPSRV_AUTH_USER_STRUCT*)users},
...
void main_task ( task_param_t init_data )
{
    ...
    if (_nio_dev_install("tfs:", &nio_tfs_dev_fn, &tfs_init) == NULL)
#endif
    {
    ...
    for (i = 0; i < n_servers; i++)
    {
        ...
        params[i].auth_table = (HTTPSRV_AUTH_REALM_STRUCT*) auth_realms;
        ...
        */
        ...
        params[i].ssi_lnk_tbl = (HTTPSRV_SSI_LINK_STRUCT *) ssi_lnk_tbl;
