...
#define TFTPSRV_MAX_TRANSACTIONS  (RTCSCFG_FD_SETSIZE-1)
...
#define TFTP_ERR_SERVER_STRING          "TFTP Server Failure."
#define TFTP_ERR_BUSY_STRING            "TFTP Server Busy."
...
/* TFTP Macros */
#define TFTP_WAIT(t) tftp_wait(t)
...
#else
extern uint32_t TFTPSRV_open_device (uint32_t, char *, char *, FILE **);
#endif
