...
typedef enum dnscln_type
{
    ...
    DNSCLN_TYPE_NS      = 0x0002,   /* An authoritative name server. */
    DNSCLN_TYPE_CNAME   = 0x0005,   /* Canonical name for an alias.*/
    DNSCLN_TYPE_NULL    = 0x000A,   /* Null Resource Record. */
    DNSCLN_TYPE_WKS     = 0x000B,   /* Service Description. */
    DNSCLN_TYPE_PTR     = 0x000C,   /* Domain name pointer, that maps an IP address to a host name for reverse lookups. */
