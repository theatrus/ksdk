...
#else
extern int32_t  FTP_open         (void **, _ip_address, FILE*);
extern int32_t  FTP_command      (void *, char *, FILE*);
extern int32_t  FTP_command_data (void *, char *, FILE*, FILE*, uint32_t);
extern int32_t  FTP_close        (void *, FILE*);
extern int32_t  FTP_receive_message(void *, FILE*);
#endif
