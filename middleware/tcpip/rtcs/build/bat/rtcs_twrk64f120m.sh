...
mkdir -p "${OUTPUTDIR}"
mkdir -p "${OUTPUTDIR}/."
cp -f "${ROOTDIR}/rtcs/source/port/fsl_enet_rtcs_adapter.h" "${OUTPUTDIR}/fsl_enet_rtcs_adapter.h"
...
cp -f "${ROOTDIR}/rtcs/source/include/dhcp6.h" "${OUTPUTDIR}/dhcp6.h"
cp -f "${ROOTDIR}/rtcs/source/include/dhcpcln6.h" "${OUTPUTDIR}/dhcpcln6.h"
...
cp -f "${ROOTDIR}/rtcs/source/include/echocln.h" "${OUTPUTDIR}/echocln.h"
...
cp -f "${ROOTDIR}/rtcs/source/include/httpsrv_script.h" "${OUTPUTDIR}/httpsrv_script.h"
cp -f "${ROOTDIR}/rtcs/source/include/httpsrv_ws.h" "${OUTPUTDIR}/httpsrv_ws.h"
cp -f "${ROOTDIR}/rtcs/source/include/icmp.h" "${OUTPUTDIR}/icmp.h"
cp -f "${ROOTDIR}/rtcs/source/include/iwcfg.h" "${OUTPUTDIR}/iwcfg.h"
cp -f "${ROOTDIR}/rtcs/source/include/llmnrsrv.h" "${OUTPUTDIR}/llmnrsrv.h"
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_base64.h" "${OUTPUTDIR}/rtcs_base64.h"
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_sha1.h" "${OUTPUTDIR}/rtcs_sha1.h"
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_user_config.h" "${OUTPUTDIR}/rtcs_user_config.h"
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_utf8.h" "${OUTPUTDIR}/rtcs_utf8.h"
...
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_ssl.h" "${OUTPUTDIR}/rtcs_ssl.h"
...
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_hosts.h" "${OUTPUTDIR}/rtcs_hosts.h"
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_assert.h" "${OUTPUTDIR}/rtcs_assert.h"
cp -f "${ROOTDIR}/rtcs/source/include/echosrv.h" "${OUTPUTDIR}/echosrv.h"
...
cp -f "${ROOTDIR}/rtcs/source/include/rtcs_util.h" "${OUTPUTDIR}/rtcs_util.h"
...
cp -f "${ROOTDIR}/rtcs/source/include/telnetcln.h" "${OUTPUTDIR}/telnetcln.h"
cp -f "${ROOTDIR}/rtcs/source/include/telnetsrv.h" "${OUTPUTDIR}/telnetsrv.h"
cp -f "${ROOTDIR}/rtcs/source/include/tftpcln.h" "${OUTPUTDIR}/tftpcln.h"
cp -f "${ROOTDIR}/rtcs/source/include/tftpsrv.h" "${OUTPUTDIR}/tftpsrv.h"
