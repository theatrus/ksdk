...
extern int usb_msd_install(struct msd_dev_data_struct *dev_data, uint32_t *mountp);
extern int usb_msd_uninstall(void *usb_handle, uint32_t *mountp, bool force);
