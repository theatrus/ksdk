...
static _mfs_error MFS_get_fat12
    ...
    uint32_t            *cluster_number_ptr   /* [OUT] Pointer to return entry data */
    )
{
    uint32_t sector;
    uint32_t offset;
...
static _mfs_error MFS_put_fat12
    ...
    uint32_t            *code_prev   /* [OUT] code read from FAT prior modification */
    )
{
    uint32_t sector;
    uint32_t offset;
...
static _mfs_error MFS_put_fat32
    ...
    uint32_t             fat_entry,    /* [IN] FAT entry index */
    uint32_t             code,         /* [IN] code to write into the FAT index */
    uint32_t            *code_prev_ptr /* [OUT] code read from FAT prior modification */
    )
{
    uint32_t sector;
    uint32_t offset;
