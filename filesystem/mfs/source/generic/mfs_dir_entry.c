...
* Comments  :  Update write timestamp of the file, and sync the directory entry
*
*END*---------------------------------------------------------------------*/
...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    : MFS_Update_entries
* Returned Value   : error_code
* Comments  :  Update directory entries of all open files
*
*END*---------------------------------------------------------------------*/
