...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    : MFS_ioctl
* Returned Value   : int
* Comments         :
*    The returned value is 0 or an MQX error code.
*
*END*----------------------------------------------------------------------*/
int MFS_ioctl
    (
       ...
       unsigned long int cmd,             /* [IN] the ioctl command */
...
int MFS_vioctl
    (
       ...
       MFS_HANDLE_PTR          handle,    /* [IN] file handle upon which the action is to be taken */
       unsigned long int cmd,             /* [IN] the ioctl command */
       va_list ap                         /* [IN] the ioctl parameters */
    )
{
    uint32_t                *param_ptr;
