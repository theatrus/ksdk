...
static _nio_off_t _io_mfs_lseek(void *dev_context, void *fp_context, _nio_off_t offset, int whence);
    ...
    )
{
    ...
    if (result > 0) result = -result; /* NIO expects error codes to be negative */
