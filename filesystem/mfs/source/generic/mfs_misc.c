...
*
* Function Name    : ilog2
* Returned Value   : Binary logarithm of the argument truncated to integer
* Comments  :        Finds the highest 1 bit in the argument using bisection
*
*
*END*---------------------------------------------------------------------*/
...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    : MFS_Create_drive
* Returned Value   : error code
* Comments  :   Allocates and initializes drive context structure
*
*END*---------------------------------------------------------------------*/
...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    : MFS_Destoy_drive
* Returned Value   : error code
* Comments  :   Deallocates drive context structure
*
*END*---------------------------------------------------------------------*/
...
* Returned Value   :  error code
* Comments  : Obtains the MFS drive lock. Cannot be called from an ISR.
*
*
*END*---------------------------------------------------------------------*/
...
* Returned Value   :  error code
* Comments  :  Releases the MFS drive lock.
*
*END*---------------------------------------------------------------------*/
...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    :  MFS_enter
* Returned Value   :  error code
* Comments  : Verifies that the drive is mounted and possibly checks other preconditions.
...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    :  MFS_leave
* Returned Value   :  error code
* Comments  :  Executes operations to be done before leaving MFS call.
*              The function assumes that the drive is locked.
*
*END*---------------------------------------------------------------------*/
...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    :  MFS_lock_and_enter
* Returned Value   :  error code
* Comments  : Locks the drive and executes operations to be done upon entering MFS call.
...
/*FUNCTION*-------------------------------------------------------------------
*
* Function Name    :  MFS_leave_and_unlock
* Returned Value   :  error code
* Comments  :  Executes operations to be done before leaving MFS call
