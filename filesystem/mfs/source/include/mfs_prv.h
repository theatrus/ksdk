...
DIR_ENTRY_DISK_PTR MFS_Find_entry_on_disk(MFS_DRIVE_STRUCT_PTR, char *, uint32_t *, uint32_t *, uint32_t *, uint32_t *);
...
_mfs_error        MFS_get_lfn_of_entry(MFS_DRIVE_STRUCT_PTR, DIR_ENTRY_DISK_PTR, uint32_t, uint32_t, uint32_t, char *);
...
_mfs_error MFS_chain_init(MFS_DRIVE_STRUCT_PTR drive_ptr, struct fat_chain *chain, uint32_t head_cluster);
_mfs_error MFS_chain_create(MFS_DRIVE_STRUCT_PTR drive_ptr, struct fat_chain *chain, uint32_t *head_cluster_ptr);
_mfs_error MFS_chain_locate(MFS_DRIVE_STRUCT_PTR drive_ptr, struct fat_chain *chain, uint32_t pos, uint32_t extend_to, uint32_t *sector, uint32_t *sector_count);
