...
******************************************************************************/
  ...
  ****************************************************************************/
  ...
  extern Frac32 GDFLIB_FilterMA_F32(Frac32 f32In, GDFLIB_FILTER_MA_T_F32 *pParam);
...
******************************************************************************/
  ...
  *//**********************************************************************/
  ...
  typedef struct{
    Frac32   f32Acc;         /*!< Filter accumulator. */
    UWord16      u16NSamples;    /*!< Number of samples for averaging, filter sample window [0,15].*/
  ...
  ****************************************************************************/
  ...
  extern Frac16 GDFLIB_FilterMA_F16(Frac16 f16In, GDFLIB_FILTER_MA_T_F16 *pParam);
