...
****************************************************************************/
  ...
  #define GFLIB_RAMP_DEFAULT_F32 {0,0,0}     /*!< Default value for GFLIB_RAMP_T_F32. */
...
****************************************************************************/
  extern Frac32 GFLIB_Ramp_F32(Frac32 f32In,GFLIB_RAMP_T_F32 * const pParam);
...
****************************************************************************/
  ...
  #define GFLIB_RAMP_DEFAULT_F16 {0,0,0}     /*!< Default value for GFLIB_RAMP_T_F16. */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    Frac16 f16State; /*!< Ramp state value. */
    Frac16 f16RampUp; /*!< Ramp up increment coefficient. */
    Frac16 f16RampDown; /*!< Ramp down increment (decrement) coefficient. */
  }GFLIB_RAMP_T_F16;

/****************************************************************************
* Exported function prototypes
****************************************************************************/
  extern Frac16 GFLIB_Ramp_F16(Frac16 f16In,GFLIB_RAMP_T_F16 * const pParam);
