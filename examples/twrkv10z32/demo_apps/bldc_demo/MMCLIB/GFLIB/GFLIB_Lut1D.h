...
****************************************************************************/
  ...
  #define GFLIB_LUT1D_DEFAULT_F32 {0,0}     /*!< Default value for GFLIB_LUT1D_T_F32. */
  ...
  *//*************************************************************************/
  ...
  typedef struct{
    UWord32 u32ShamOffset; /*!< Shift amount for extracting the fractional offset within an interpolated interval. */
...
****************************************************************************/
  extern Frac32 GFLIB_Lut1D_F32(Frac32 f32In,const GFLIB_LUT1D_T_F32 * const pParam);
...
****************************************************************************/
  ...
  #define GFLIB_LUT1D_DEFAULT_F16 {0,0}     /*!< Default value for GFLIB_LUT1D_T_F16. */
  ...
  *//*************************************************************************/
  ...
  typedef struct{
    UWord16 u16ShamOffset; /*!< Shift amount for extracting the fractional offset within an interpolated interval. */
...
* Exported function prototypes
****************************************************************************/
  extern Frac16 GFLIB_Lut1D_F16(Frac16 f16In,const GFLIB_LUT1D_T_F16 * const pParam);
