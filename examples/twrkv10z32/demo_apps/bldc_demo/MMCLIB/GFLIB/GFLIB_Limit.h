...
****************************************************************************/
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    Frac32 f32LowerLimit; /*!< Value determining the lower limit threshold. */
    Frac32 f32UpperLimit; /*!< Value determining the upper limit threshold. */
  }GFLIB_LIMIT_T_F32;

/****************************************************************************
* Exported function prototypes
****************************************************************************/
  extern Frac32 GFLIB_Limit_F32(Frac32 f32In,const GFLIB_LIMIT_T_F32 * const pParam);
...
****************************************************************************/
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    Frac16 f16LowerLimit; /*!< Value determining the lower limit threshold. */
    Frac16 f16UpperLimit; /*!< Value determining the upper limit threshold. */
  }GFLIB_LIMIT_T_F16;

/****************************************************************************
* Exported function prototypes
****************************************************************************/
  extern Frac16 GFLIB_Limit_F16(Frac16 f16In,const GFLIB_LIMIT_T_F16 * const pParam);
