...
void main(void)
{
    ...
    f32Out = MLIB_ShBiSat_F32(f32In1, w16In2);

    // output should be 0x10000000 ~ FRAC32(0.125)
    f32Out = MLIB_ShBiSat(f32In1, w16In2, F32);
    ...
    // output should be 0x10000000 ~ FRAC32(0.125)
    f32Out = MLIB_ShBiSat(f32In1, w16In2);
}
\endcode
****************************************************************************/
/** @remarks Implements DMLIB00155, DMLIB00149, DMLIB00153 */
static inline Frac32 MLIB_ShBiSat_F32(register Frac32 f32In1,register Word16 w16In2)
/*
...
*/
{
  ...
  */
  ...
  return(w16In2<(Word16)0) ? MLIB_ShR_F32(f32In1, (UWord16)(-w16In2)) : MLIB_ShLSat_F32(f32In1, (UWord16)(w16In2));
}
...
void main(void)
{
    ...
    f16Out = MLIB_ShBiSat_F16(f16In1, w16In2);

    // output should be 0x1000 ~ FRAC16(0.125)
    f16Out = MLIB_ShBiSat(f16In1, w16In2, F16);
    ...
    // output should be 0x1000 ~ FRAC16(0.125)
    f16Out = MLIB_ShBiSat(f16In1, w16In2);
}
\endcode
****************************************************************************/
/** @remarks Implements DMLIB00155, DMLIB00149, DMLIB00153 */
static inline Frac16 MLIB_ShBiSat_F16(register Frac16 f16In1,register Word16 w16In2)
/*
* @violates @ref MLIB_ShBiSat_h_REF_5 MISRA 2004 Required Rule 8.5, Object/function definition in
* header file.
*/
{
  ...
  */
  ...
  return(w16In2<(Word16)0) ? MLIB_ShR_F16(f16In1, (UWord16)(-w16In2)) : MLIB_ShLSat_F16(f16In1, (UWord16)(w16In2));
}
