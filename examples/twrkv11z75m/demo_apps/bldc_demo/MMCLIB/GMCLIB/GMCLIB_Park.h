...
****************************************************************************/
  extern void GMCLIB_Park_F32(MCLIB_2_COOR_SYST_D_Q_T_F32 *pOut,const MCLIB_ANGLE_T_F32 *const pInAngle,const MCLIB_2_COOR_SYST_ALPHA_BETA_T_F32 *const pIn);
...
* Exported function prototypes
****************************************************************************/
  extern void GMCLIB_Park_F16(MCLIB_2_COOR_SYST_D_Q_T_F16 *pOut,const MCLIB_ANGLE_T_F16 *const pInAngle,const MCLIB_2_COOR_SYST_ALPHA_BETA_T_F16 *const pIn);
