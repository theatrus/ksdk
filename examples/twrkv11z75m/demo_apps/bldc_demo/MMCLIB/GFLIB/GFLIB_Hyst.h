...
****************************************************************************/
  ...
  #define GFLIB_HYST_DEFAULT_F32 {0,0,0,0,0}     /*!< Default value for GFLIB_HYST_T_F32. */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    Frac32 f32HystOn; /*!< Value determining the upper threshold. */
    Frac32 f32HystOff; /*!< Value determining the lower threshold. */
    Frac32 f32OutValOn; /*!< Value of the output when input is higher than the upper threshold. */
    Frac32 f32OutValOff; /*!< Value of the output when input is higher than the upper threshold. */
    Frac32 f32OutState; /*!< Actual state of the output. */
  }GFLIB_HYST_T_F32;

/****************************************************************************
* Exported function prototypes
****************************************************************************/
  extern Frac32 GFLIB_Hyst_F32(Frac32 f32In,GFLIB_HYST_T_F32 * const pParam);
...
****************************************************************************/
  ...
  #define GFLIB_HYST_DEFAULT_F16 {0,0,0,0,0}     /*!< Default value for GFLIB_HYST_T_F16. */
  ...
  *//***********************************************************************/
  ...
  typedef struct{
    Frac16 f16HystOn; /*!< Value determining the upper threshold. */
    Frac16 f16HystOff; /*!< Value determining the lower threshold. */
    Frac16 f16OutValOn; /*!< Value of the output when input is higher than the upper threshold. */
    Frac16 f16OutValOff; /*!< Value of the output when input is higher than the upper threshold. */
    Frac16 f16OutState; /*!< Actual state of the output. */
  }GFLIB_HYST_T_F16;

/****************************************************************************
* Exported function prototypes
****************************************************************************/
  extern Frac16 GFLIB_Hyst_F16(Frac16 f16In,GFLIB_HYST_T_F16 * const pParam);
